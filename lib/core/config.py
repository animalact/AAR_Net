...
config.TRAIN_INPUT_DIR = 'train_input'
config.TRAIN_LABEL_DIR = 'train_label'
config.TEST_INPUT_DIR = 'test_input'
config.TEST_LABEL_DIR = 'test_label'
...
config.TRAIN.VALIDATION_RATIO = 0.2
